...
def run_pipeline(request: CompareRequest) -> CompareResponse:
    ...
    """
    print(f"Running Candidate Comparison Pipeline for user {request.user_id} vs {request.competitor}")
...
if __name__ == "__main__":
    # Test execution
    print(run_pipeline(CompareRequest(user_id="user1", job_posting_id="12345", competitor="user2")))
