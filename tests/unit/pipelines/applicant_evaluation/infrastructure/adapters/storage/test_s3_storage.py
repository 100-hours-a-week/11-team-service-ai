...
from pipelines.applicant_evaluation.infrastructure.adapters.storage.s3_storage import S3FileStorage

@pytest.fixture
def mock_s3_client():
    with patch("pipelines.applicant_evaluation.infrastructure.adapters.storage.s3_storage.boto3.client") as mock:
        yield mock
