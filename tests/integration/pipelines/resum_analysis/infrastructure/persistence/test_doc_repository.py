...
from pipelines.resume_analysis.domain.models.document import ApplicantDocument, DocumentType
...
async def test_get_document_integration(db_session: AsyncSession):
    ...
    # 3. 포트폴리오 조회
    portfolio_doc = await repo.get_document(user_id, job_id_portfolio, DocumentType.PORTFOLIO)
